...
return [
    ...
    */
    ...
    // 'socket_type' => defined('SWOOLE_UNIX_STREAM') ? SWOOLE_UNIX_STREAM : 1,
    ...
    */
    ...
    'swoole' => [
        ...
        'buffer_output_size' => (int) env('SWOOLE_BUFFER_OUTPUT_SIZE', 64) * 1024 * 1024,
        'socket_buffer_size' => (int) env('SWOOLE_SOCKET_BUFFER_SIZE', 128) * 1024 * 1024,
        'package_max_length' => (int) env('SWOOLE_PACKAGE_MAX_LENGTH', 64) * 1024 * 1024,
        'reload_async' => true,
        'max_wait_time' => 60,

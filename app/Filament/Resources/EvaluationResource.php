...
class EvaluationResource extends Resource
{
    ...
    {
        return [
            'Evaluation.index' => __('Allows viewing the Evaluation list'),
            'Evaluation.view' => __('Allows viewing Evaluation detail'),
            'Evaluation.create' => __('Allows creating a new Evaluation'),
            'Evaluation.update' => __('Allows updating Evaluations'),
            'Evaluation.delete' => __('Allows deleting Evaluations'),
        ];
    }

...
class BidItemResource extends Resource
{
    ...
    {
        return [
            'BidItem.index' => __('Allows viewing the BidItem list'),
            'BidItem.view' => __('Allows viewing BidItem detail'),
            'BidItem.create' => __('Allows creating a new BidItem'),
            'BidItem.update' => __('Allows updating BidItems'),
            'BidItem.delete' => __('Allows deleting BidItems'),
        ];
    }

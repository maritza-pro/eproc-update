...
class ProcurementItemResource extends Resource
{
    ...
    {
        return [
            'ProcurementItem.index' => __('Allows viewing the ProcurementItem list'),
            'ProcurementItem.view' => __('Allows viewing ProcurementItem detail'),
            'ProcurementItem.create' => __('Allows creating a new ProcurementItem'),
            'ProcurementItem.update' => __('Allows updating ProcurementItems'),
            'ProcurementItem.delete' => __('Allows deleting ProcurementItems'),
        ];
    }
